...
function AddRoleAndResponsibilityForm({ style }) {
  ...
  const handleFormSubmit = () => {
    if (!name.trim()) {
      toast.warn("Please enter Menu Name.");
      return;
    }
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_BASE_URL}/v1/admin/menu_plan/add`,
        data,
        {
          headers: {
      ...
      .then((response) => {
        toast.success("Roles & Responsbility Created Successfully");
        setTimeout(() => {
          navigate("/roles-list");
        }, 2000);
      })
...
export default AddRoleAndResponsibilityForm;
