...
function AddItemAttributesForm() {
  ...
  const [variantsDetails, setVariantsDetails] = useState([{ variant: "" }]);
  ...
  const handleFormSubmit = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_BASE_URL}/v1/admin/attributes/add`, data, {
        headers: {
...
export default AddItemAttributesForm;
