...
export default function CustomizedAccordions({
  ...
  const handlePriceChange = (index, mrpName, fieldName, value) => {
    ...
    setVariantsFormDetails((prev) => {
      ...
      const sellingPrice = parseFloat(updatedVariants[index]?.selling_price);
      let percentage = 0;
      ...
      setCrossPriceError((prevErrors) => {
        ...
        if (fieldName === "cross_price") {
          if (price <= sellingPrice) {
            updatedErrors[index] =
              "Cross price must be greater than selling price";
          } else {
            updatedErrors[index] = ""; // Clear error for this index if valid
          }
        }
              ...
              >
                ...
                >
                  ...
                  <RadioGroup
                    ...
                    name="deliveryType"
                    value={variantsFormDetails[index]?.item_delivery_type || ""}
                    onChange={(e) =>
                      handleInputChange(
                        index,
                        "item_delivery_type",
                ...
                >
                  ...
                  >
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={variantsFormDetails[index]?.delivery_ex || false}
                          onChange={(e) =>
                            handleInputChange(index, "delivery_ex", e.target.checked)
                          }
                          disabled={
                            priceMode === "regular" || priceMode === "logical"
                          }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={variantsFormDetails[index]?.delivery_for || false}
                          onChange={(e) =>
                            handleInputChange(index, "delivery_for", e.target.checked)
                          }
                          disabled={
                            priceMode === "regular" || priceMode === "logical"
                          }
                ...
                {variantsFormDetails[index]?.delivery_ex && (
                  <>
                    ...
                    >
                      ...
                      <TextField
                        value={variantsFormDetails[index]?.selling_price}
                        onChange={(e) =>
                          handlePriceChange(
                            index,
                            "mrp",
                    ...
                    >
                      ...
                      <TextField
                        value={
                          variantsFormDetails[index]?.selling_price_percent
                        }
                        onChange={(e) =>
                          handlePercentChange(
                            index,
                    ...
                    >
                      ...
                      <TextField
                        value={variantsFormDetails[index]?.cross_price}
                        onChange={(e) =>
                          handlePriceChange(
                            index,
                            "mrp",
                        ...
                        required
                        placeholder="Enter Price"
                        error={crossPriceError[index]}
                        helperText={crossPriceError[index]}
                        disabled={
                          priceMode === "regular" || priceMode === "logical"
                        }
                      />
                      {crossPriceError[index]}
                    </div>
                    <div
                      className={`${customClasses.dflex} ${customClasses.flexdirectioncolumn} ${customClasses.mt0_5} ${customClasses.w49}`}
                    >
                      ...
                      <TextField
                        value={variantsFormDetails[index]?.cross_price_percent}
                        onChange={(e) =>
                          handlePercentChange(
                            index,
                            "mrp",
