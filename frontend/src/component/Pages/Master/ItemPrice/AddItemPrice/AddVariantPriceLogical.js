...
function AddVariantPriceLogical({
  ...
  const handleSubmit = () => {
    ...
    if (!formValues.mrp || isNaN(parseFloat(formValues.mrp))) {
    ...
    const baseMrp = parseFloat(formValues.mrp) || 0;
    const baseSelling = parseFloat(formValues.selling_price) || 0;
    const baseCross = parseFloat(formValues.cross_price) || 0;
    ...
    const updatedVariants = mergedCombinations.map((variant) => {
      ...
      if (isBase) {
        ...
        return {
          ...
          selling_price: (baseSelling + extraPrice).toFixed(2),
          cross_price: (baseCross + extraPrice).toFixed(2),
  ...
  return (
    <>
      <ToastContainer />
      <div
        className={`${classes.bgwhite} ${classes.w50} ${classes.h82vh} ${classes.pagescroll} ${classes.dflex} ${classes.flexdirectioncolumn} ${classes.inputpadding} ${classes.inputborder} ${classes.boxshadow3} ${classes.borderradius6px} ${classes.p1} ${classes.px2}`}
      >
        <PageHeader Heading={Heading} />
        <div
          className={`${classes.dflex} ${classes.flexdirectioncolumn} ${classes.alignitemscenter} ${classes.justifyspacebetween} ${classes.inputpadding} ${classes.inputborder} ${classes.boxshadow3} ${classes.borderradius6px} ${classes.p1} ${classes.px2}`}
        >
          <div
