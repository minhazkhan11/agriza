...
function PriceUpdateForm({
  ...
  return (
    <>
      <ToastContainer />
      <div
        className={`${classes.bgwhite} ${classes.w100} ${classes.dflex} ${classes.flexdirectioncolumn} ${classes.justifyspacebetween} ${classes.inputpadding} ${classes.inputborder} ${classes.boxshadow3} ${classes.borderradius6px} ${classes.px2}`}
      >
        <div
            ...
            <>
              ...
              >
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    handlePercentChange("mrp", "selling_price", e.target.value)
                  }
                  type="text"
                  variant="outlined"
                  required
