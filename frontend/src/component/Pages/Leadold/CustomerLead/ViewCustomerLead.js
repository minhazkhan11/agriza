...
function ViewCustomerLead() {
  ...
  const rows = product.map((d) => ({
    ...
    primary_quantity: d.primary_quantity ? d.primary_quantity : "N/A",
    product_category_name: d.product_category_id?.category_name
...
export default ViewCustomerLead;
