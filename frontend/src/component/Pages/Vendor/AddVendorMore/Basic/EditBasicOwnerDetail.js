          ...
          >
            ...
            >
              ...
              <TextField
                ...
                value={row[ownerDetailsindex].first_name}
                name="category_name"
                type="text"
                variant="outlined"
                required
            ...
            >
              ...
              <TextField
                ...
                value={row[ownerDetailsindex].father_name}
                name="category_name"
                type="text"
                variant="outlined"
                required
            ...
            >
              ...
              <TextField
                ...
                value={row[ownerDetailsindex].phone}
                name="category_name"
                type="text"
                inputProps={{
                  maxLength: 10,
            ...
            >
              ...
              <TextField
                ...
                value={row[ownerDetailsindex].alternative_phone}
                name="category_name"
                type="text"
                inputProps={{
                  maxLength: 10,
            ...
            >
              ...
              <TextField
                ...
                value={row[ownerDetailsindex].password}
                name="category_name"
                type="text"
                inputProps={{
                  maxLength: 10,
            ...
            >
              ...
              <TextField
                ...
                value={row[ownerDetailsindex].r_address}
                name="r_address"
                type="text"
                multiline
                rows={4}
            ...
            >
              ...
              <Autocomplete
                ...
                disableClearable
                value={pin.find((sub) => sub.id === row[ownerDetailsindex].pincode_id)}
            ...
            >
              ...
              <Autocomplete
                ...
                disableClearable
                value={place?.find((sub) => sub.id === row[ownerDetailsindex].place_id) || ""}
            ...
            >
              ...
              <TextField
                ...
                value={row[ownerDetailsindex].aadhaar}
                name="category_name"
                type="text"
                inputProps={{
                  maxLength: 12,
...
export default EditBasicOwnerDetail;
