...
function GstDetail({ setValue, businessEntityId }) {
  ...
  const handleFormSubmit = () => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_BASE_URL}/v1/admin/vendor_be_gst_details/add`,
        data,
        {
          headers: {
                  ...
                  {rDistrictStateTehsil[index]?.state && (
                    ...
                    >
                      ...
                      <Select
                        ...
                        disabled
                      >
                        <MenuItem value={rDistrictStateTehsil[index]?.state?.state_name}>
                  ...
                  {rDistrictStateTehsil[index]?.district && (
                    ...
                    >
                      ...
                      <Select
                        ...
                        id="country"
                        required
                        value={rDistrictStateTehsil[index]?.district?.district_name}
