...
function License({ setValue, businessEntityId }) {
  ...
  const handleFileUpload = async (index, field, e) => {
    const file = e.target.files[0];

    try {
      const formData = new FormData();
      const entitytype = "licensedetails";
      ...
      if (response.status === 200) {
        ...
        handleRowChange(index, field, uploadedFileUrl);
      } else {
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <TextField
                      name="signatureandseal"
                      onChange={(e) =>
                        handleFileUpload(index, "signatureandseal", e)
                      }
                  ...
                  >
                    ...
                    <TextField
                      name="license"
                      onChange={(e) => handleFileUpload(index, "license", e)}
                      type="file"
                      variant="outlined"
                      required
                    />
                ...
                >
                  ...
                  >
                    <UploadPreview
                      thumbnailImagePreview={row.signatureandseal}
                    />
                  </div>
                  ...
                  <div
                    className={`${classes.w24} ${classes.mt1_5}  ${classes.dflex} ${classes.justifycenter}`}
                  >
                    <UploadPreview thumbnailImagePreview={row.license} />
                  </div>
