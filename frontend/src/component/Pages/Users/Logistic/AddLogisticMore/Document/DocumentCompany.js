...
function DocumentCompany({ businessEntityId }) {
            ...
            <div
              ...
              >
                <Typography
                  ...
                  display="inline"
                >
                  Certificate of Incorporation <span className={classes.textcolorred}>*</span>
                </Typography>
                <div className={`${classes.w32}`}>
                  <UploadButtons
                    onImageChange={handleThumbnailImageChangeNew}
              ...
              >
                <Typography
                  ...
                  display="inline"
                >
                  PAN of the authorized signatory <span className={classes.textcolorred}>*</span>
                </Typography>
                <div className={`${classes.w32}`}>
                  <UploadButtons
                    onImageChange={handleThumbnailImageChangeNew}
                    ...
                    setThumbnailImage={setThumbnailImage}
                    thumbnailImage={thumbnailImage}
                    fieldName="attested_pan_of_the_authorized_signatory"
                    thumbnailImagePreview={thumbnailImagePreview}
                    setThumbnailImagePreview={setThumbnailImagePreview}
                  />
                </div>
              ...
              >
                <Typography
                  ...
                  display="inline"
                >
                  Adhaar of the authorized signatory <span className={classes.textcolorred}>*</span>
                </Typography>
                <div className={`${classes.w32}`}>
                  <UploadButtons
                    onImageChange={handleThumbnailImageChangeNew}
                    ...
                    setThumbnailImage={setThumbnailImage}
                    thumbnailImage={thumbnailImage}
                    fieldName="attested_adhaar_of_the_authorized_signatory"
                    thumbnailImagePreview={thumbnailImagePreview}
                    setThumbnailImagePreview={setThumbnailImagePreview}
                  />
                </div>
              ...
              >
                <Typography
                  ...
                  display="inline"
                >
                   MOA of the company <span className={classes.textcolorred}>*</span>
                </Typography>
                <div className={`${classes.w32}`}>
                  <UploadButtons
                    onImageChange={handleThumbnailImageChangeNew}
              ...
              >
                <Typography
                  ...
                  display="inline"
                >
                   AOA of the company <span className={classes.textcolorred}>*</span>
                </Typography>
                <div className={`${classes.w32}`}>
                  <UploadButtons
                    onImageChange={handleThumbnailImageChangeNew}
