...
export default function CustomizedAccordions({
  ...
  const handleDeleteWithId = async (rowId, index) => {
    try {
      ...
      toast.success("Owner/Partner/Director Details deleted successfully");
      setFormDetails((prev) => ({
        ...prev,
        owner_details: prev.owner_details.filter((_, i) => i !== index),
      }));
    } catch (error) {
      toast.error("Owner/Partner/Director Details is not deleted");
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    {data.admin === "yes" ? " Admin" : "Make Admin"}
                  </Button>
                  <IconButton
                    onClick={(event) => {
                      event.stopPropagation();
                    ...
                    <LightTooltip title="Delete">
                      <DeleteIcon
                        ...
                        onClick={(event) => {
                          event.stopPropagation();
                          if (data?.id) {
                            handleDeleteWithId(data.id, index);
                          } else {
                            handleDelete(index);
                          }
                        }}
