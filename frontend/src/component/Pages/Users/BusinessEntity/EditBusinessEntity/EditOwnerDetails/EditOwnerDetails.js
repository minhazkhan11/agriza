...
function EditOwnerDetails({ setValue, businessEntityId }) {
  ...
  useEffect(() => {
    if (bankDetails && bankDetails.length > 0) {
      const firstBankDetail = bankDetails[0]; // Update based on the first item
      setFiles({
        photo: firstBankDetail?.photo || null,
        aadhar_upload: firstBankDetail?.aadhar_upload || null,
        pan_upload: firstBankDetail?.pan_upload || null,
      });
    }
  }, [bankDetails]);
  ...
  console.log("bankDetails", bankDetails, files);
              ...
              <React.Fragment key={index}>
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <Autocomplete
                        ...
                        disableClearable
                        value={
                          pin?.find((sub) => sub.id === row.pincode_id) || null
                        }
                    ...
                    >
                      ...
                      <Autocomplete
                        ...
                        disableClearable
                        value={
                          place?.find((sub) => sub.id === row.place_id) || null
                        }
                  ...
                  >
                    ...
                    >
                      <UploadPreview
                        thumbnailImagePreview={
                          files.aadhar_upload instanceof File
                    ...
                    {/* <UploadPreview
                      thumbnailImagePreview={
                        files.pan_upload && files.pan_upload
                      }
                    /> */}
                    ...
                    <div
                      className={`${classes.w24} ${classes.mt1_5}  ${classes.dflex} ${classes.justifycenter}`}
                    >
                      {console.log("UploadPreview", files.pan_upload)}
                      <UploadPreview thumbnailImagePreview={files.pan_upload} />
                    </div>
                  </div>
                </>
              </React.Fragment>
