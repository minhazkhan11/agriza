...
function EditDocumentCompany({ businessEntityId }) {
  ...
  const handleSubmit = () => {
    if (
      !thumbnailImage ||
      !thumbnailImage.pan_of_the_company ||
      !thumbnailImage.pan_of_the_company.trim()
    ) {
      toast.warn("Please upload the PAN of the company.");
      return;
    }
    if (
      !thumbnailImage ||
      !thumbnailImage.gst_certificate ||
      !thumbnailImage.gst_certificate.trim()
    ) {
      toast.warn("Please upload the GST certificate.");
      return;
    }
    navigate("/business-entity-list");
  };
                 ...
                 <div
                        ...
                        >
                          ...
                          >
                            ...
                            <span
                              className={`${classes.textcolorred} ${classes.fontsize12px} ${classes.lineheight1}`}
                            >
                              <br />
                              Note: All extra documents can be uploaded here in single PDF
                            </span>
                          </Typography>
                          <div className={`${classes.w32}`}>
                            <UploadButtons
