...
import EditOwnerDetails from "../OwnerDetails/OwnerDetails";
...
function EditBasic({
  ...
  const initialData = {
    ...
    gst_pincode_id: basicDetails?.gst_pincode_id?.id || "",
  ...
  const [selectedGstPin, setSelectedGstPin] = useState(
    basicDetails?.gst_pincode_id || ""
  );
  const [selectedGstPinId, setSelectedGstPinId] = useState(
    basicDetails?.gst_pincode_id?.id || ""
  );
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_API_BASE_URL}/v1/admin/business_entity_basic/customer`,
        formData,
        {
          headers: {
  ...
  return (
    <>
      ...
      <div className={`${classes.inputpadding} ${classes.inputborder}`}>
        <FormControl className={`${classes.w100}`}>
          <div
            className={`${classes.bgwhite} ${classes.boxshadow3} ${classes.borderradius6px} ${classes.py2} ${classes.px1_5} ${classes.mt1}  ${classes.pagescroll}  ${classes.maxh68}`}
          >
            <div
              ...
              {formDetails.is_Business === "registered" ? (
                ...
                >
                  ...
                  <TextField
                    ...
                    disabled={formDetails.is_Business === "registered"}
                ...
                >
                  ...
                  <TextField
                    ...
                    disabled={formDetails.is_Business === "notregistered"}
                    name="category_name"
                    type="text"
                    variant="outlined"
                    required
            ...
            >
              ...
              >
                ...
                <Autocomplete
                  ...
                  value={
                    gstPlace?.find(
                      (sub) => sub.id === formDetails.gst_place_id
                    ) || null
                  }
            ...
            <EditOwnerDetails businessEntityId={businessEntityId} />
          </div>

          <div
            className={`${classes.dflex} ${classes.justifyflexend} ${classes.mx0_5}`}
          >
            <Button
            ...
            <Button
              className={`${classes.custombtnblue} ${classes.mr1}`}
