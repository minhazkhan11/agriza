...
function RemarkPopup({ handlePopUp, data, open }) {
  ...
  const handleCheck = () => {
    axios
      .post(
        `${process.env.REACT_APP_API_BASE_URL}/v1/admin/be_customer/gstpan`,
        data,
        {
          headers: {
      ...
      .then((response) => {
        ...
        navigate("/add-customer-more", { state: localState })
        ...
        <div className={classes.paper}>
          ...
          >
            ...
            >
              <Typography
                variant="h3"
                className={`${classesCustom.mt1} ${classesCustom.fw700} ${classesCustom.textcolorformlabel} ${classesCustom.fontfamilyoutfit} ${classesCustom.dflex} ${classesCustom.dflex} ${classesCustom.flexdirectioncolumn} ${classesCustom.fontSize12} ${classesCustom.fontstylenormal} ${classesCustom.fw400} ${classesCustom.lineheight}`}
              >
                Entity Already Registered With Agriza
              </Typography>
              <Typography
                variant="h3"
              ...
              >
                You can only add GST details if not exits simply add in to your customer list.
              </Typography>
              <Typography
                variant="h3"
                className={`${classesCustom.mt1} ${classesCustom.textcolorformlabel} ${classesCustom.fontfamilyoutfit}  ${classesCustom.fontsize} ${classesCustom.fontstylenormal} ${classesCustom.fw400} ${classesCustom.lineheight}`}
              >
