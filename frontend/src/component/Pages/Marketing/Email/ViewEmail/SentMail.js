...
function SentMail({handleMailOpen , Data}) {
  ...
  const handleDelete = () => {
    ...
    axios({
      method: "DELETE",
      url: `${process.env.REACT_APP_API_BASE_URL}/v1/b2b/mail/sent`,
      headers: {
  ...
  return (
    <div className={` ${classes.pagescroll} ${classes.h54vh}`}>
      ...
      {Data.map((data, i) => (
        <div className={`${classes.dflex} ${classes.w100} ${classes.justifyspacebetween} ${classes.alignitemscenter} ${classes.bggrey1} ${classes.p1}`}>
        ...
        >
          ...
          <div className={`${classes.dflex} ${classes.w30}`}>
            <img
              ...
              height="23px"
            />
            <Typography className={` ${classes.fontsize1} ${classes.fw600} ${classes.textoverflowhidden}`}>
              {data.name}
            </Typography>
          </div>
          {/* {!Data.read && <Typography
          ...
          <div className={`${classes.dflex} ${classes.w40} ${classes.textoverflowhidden}`}>
            <Typography
              component="span"
              className={` ${classes.fontsize1} ${classes.fw600}`}
            >
              {data.title}
              <Typography
                component="span"
