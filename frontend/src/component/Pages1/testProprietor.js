...
function EditDocumentProprietor() {
          ...
          >
            ...
            >
              <Typography
                ...
                display="inline"
              >
                Self-attested Pan <span className={classes.textcolorred}>*</span>
              </Typography>
              <div
            ...
            >
              <Typography
                ...
                display="inline"
              >
                Self-attested Aadhaar <span className={classes.textcolorred}>*</span>
              </Typography>
              <div
                className={`${classes.dflex} ${classes.flexdirectioncolumn}  ${classes.w32}`}
              >
            ...
            {registerd_type === "registered" && (
              ...
              >
                <Typography
                  ...
                  display="inline"
                >
                  GST Certificate (3 Pager) <span className={classes.textcolorred}>*</span>
                </Typography>
                <div
                  className={`${classes.dflex} ${classes.flexdirectioncolumn}  ${classes.w32}`}
                >
            ...
            {registerd_type === "registered" && (
              ...
              >
                <Typography
                  ...
                  display="inline"
                >
                  GST Returns of last 1-year <span className={classes.textcolorred}>*</span>
                </Typography>
                <div
                  className={`${classes.dflex} ${classes.flexdirectioncolumn}  ${classes.w32}`}
                >
            ...
            >
              <Typography
                ...
                display="inline"
              >
                PDF or Photo of Two Signed PDCs (the PDCs needs to be crossed A/C Payee and name of "Maitreya Capital And Business Services Pvt. Ltd." written on it. It should have no date and will be blank.)
              </Typography>
              <div
                className={`${classes.dflex} ${classes.flexdirectioncolumn}  ${classes.w32}`}
              >
            ...
            >
              <Typography
                ...
                display="inline"
              >
                Signatory Photo <span className={classes.textcolorred}>*</span>
              </Typography>
              <div
                className={`${classes.dflex} ${classes.flexdirectioncolumn}  ${classes.w32}`}
              >
            ...
            >
              ...
              >
                ...
                Establishment, etc.) <span className={classes.textcolorred}>*</span>
              </Typography>
              <div
                className={`${classes.dflex} ${classes.flexdirectioncolumn}  ${classes.w32}`}
              >
            ...
            >
              <Typography
                ...
                display="inline"
              >
                Gov License of the retailer <span className={classes.textcolorred}>*</span>
              </Typography>
              <div
                className={`${classes.dflex} ${classes.flexdirectioncolumn}  ${classes.w32}`}
              >
...
export default EditDocumentProprietor;
