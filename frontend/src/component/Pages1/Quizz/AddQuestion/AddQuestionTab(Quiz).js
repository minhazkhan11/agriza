...
import AddSingle from "./AddSingle(Quiz)";
import QuestionList from "./QuestionList(Quiz)";
...
export default function SimpleTabsQuiz() {
  ...
  const items1 = [
    ...
    { id: 2, label: <AddSingle setValue={setValue} /> },
