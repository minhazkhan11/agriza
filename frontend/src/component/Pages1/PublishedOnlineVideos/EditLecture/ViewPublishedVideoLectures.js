...
function ViewPublishedVideoLectures() {
  ...
  const fetchContentByNoteId = async () => {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_BASE_URL}/v1/b2b/content/onlinevideolectures/publishby_onlinevideo_id/${rowId}`,
        {
          method: "GET",
          headers: {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      navigate("/admin/publishedonlinevideo");
    }, 1500);
  };
  ...
  const deleteContent = async (contentID) => {
    try {
      ...
      const response = await axios.delete(
        `${process.env.REACT_APP_API_BASE_URL}/v1/b2b/content/onlinevideolectures/publish/${contentID}`,
        {
          headers: {
            Authorization: `Bearer ${decryptedToken}`,
          },
  ...
  const handleStatusForContent = (contentId, currentStatus) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_API_BASE_URL}/v1/b2b/content/onlinevideolectures/publish/status`,
        data,
        {
          headers: {
            Authorization: `Bearer ${decryptedToken}`,
  ...
  const handleStatusForLockUnlock = (contentId, currentStatus) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_API_BASE_URL}/v1/b2b/content/onlinevideolectures/publish/payment_status`,
        data,
        {
          headers: {
            Authorization: `Bearer ${decryptedToken}`,
...
export default ViewPublishedVideoLectures;
