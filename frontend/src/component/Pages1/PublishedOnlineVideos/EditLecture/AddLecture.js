...
function AddLecture(props) {
  const { handleOpenclose, open, fetchContentByNoteId, noteId } = props;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_API_BASE_URL}/v1/b2b/content/onlinevideo/add/lectures`,
