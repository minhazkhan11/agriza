...
function EditDocumentPartnership() {
          ...
          >
            ...
            >
              <Typography
                ...
                display="inline"
              >
                Attested PAN of the Partnership Firm <span className={classes.textcolorred}>*</span>
              </Typography>
              <div
            ...
            {registerd_type === "registered" && (
              ...
              >
                <Typography
                  ...
                  display="inline"
                >
                  Attested GST Certificate (3 pager) <span className={classes.textcolorred}>*</span>
                </Typography>
                <div
                  className={`${classes.dflex} ${classes.flexdirectioncolumn}  ${classes.w32}`}
                >
            ...
            >
              <Typography
                ...
                display="inline"
              >
                Govt license of the retaller <span className={classes.textcolorred}>*</span>
              </Typography>
              <div
                className={`${classes.dflex} ${classes.flexdirectioncolumn}  ${classes.w32}`}
              >
...
export default EditDocumentPartnership;
