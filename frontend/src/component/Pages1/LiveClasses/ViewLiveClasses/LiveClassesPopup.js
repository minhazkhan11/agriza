...
const LiveClassesPopup = (props) => {
  const { open, handleOpenClose, fetchData, selectedRowId } = props;
  ...
  const handleSubmit = () => {
    ...
    axios({
      method: "post",
      url: `${process.env.REACT_APP_API_BASE_URL}/v1/b2b/liveclasses/publish/add/${selectedRowId}`,
      data,
      headers: {
