...
module.exports = async (req, res) => {
  try {
        ...
        for (const attachment of attachments) {
          ...
          for (const file of files) {
            if (file) {
              ...
              const objectKey = generateObjectKeyMultiple('existingLicense', attachment.type, file.originalname);
    ...
    const updatedLicenseInfo = await Licensedetails.where({ id: body.id }).fetch({ require: false ,
