...
let appRouter = require('./routes/v1/admin/master');
let appRouter1 = require('./routes/v1/admin/index');
const responseMiddleWare = require('./middlewares/response.middleware');
const passportMiddleWare = require('./middlewares/passport.middleware');
const cors = require('cors');
const session = require('express-session');

console.log(process.env.NODE_ENV,"env12333333");
...
// app.use('/v1/admin/sms_config', passportMiddleWare.jwtAuth, appRouter.smsConfigRouter);
...
// app.use('/v1/admin/order_invoice', passportMiddleWare.jwtAuth, appRouter.OrderInviceRouter);
